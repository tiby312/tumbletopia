...
impl ActualMove {
            ...
            for a in hex::OFFSETS {
                ...
                for k in ax.ray_from_vector(Cube::from_arr(a)) {
                    ...
                    match playable.factions.get_cell(k.ax) {
                        &unit::GameCell::Piece(unit::Pieces::Normal(stack_height, fa)) => {
                            if fa == team {
                ...
                match game.factions.get_cell_inner(self.0) {
                    unit::GameCell::Piece(unit::Pieces::Normal(stack_height, v)) => {
    ...
    pub fn apply(
        ...
        let destroyed_unit = match game.factions.get_cell_inner(target_cell) {
            &unit::GameCell::Piece(unit::Pieces::Normal(stack_height, v)) => Some((stack_height.to_num() as u8, v)),
